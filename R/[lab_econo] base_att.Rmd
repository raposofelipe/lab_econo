...
```{r}
df_censo <- read.csv2("C:\\Users\\feref\\OneDrive\\Faculdade\\Lab de Econo\\docs_lab_econo\\censo\\microdados_ed_basica_2013.csv") 

df_censo <- df_censo %>% 
  rbind(read.csv2("C:\\Users\\feref\\OneDrive\\Faculdade\\Lab de Econo\\docs_lab_econo\\censo\\microdados_ed_basica_2019.csv"))
```
...
ideb_muni <- readxl::read_excel(
  "C:\\Users\\feref\\OneDrive\\Faculdade\\Lab de Econo\\docs_lab_econo\\ideb_lab_de_econo\\ideb_ai_mun.xlsx") %>% 
...
```{r}
educacao_muni <- readxl::read_excel("C:\\Users\\feref\\OneDrive\\Faculdade\\Lab de Econo\\docs_lab_econo\\Base Final Educação - Investimentos - SIOPE - Procedimento Completo - Imputar Missings e Outliers.xlsx") %>% 
  group_by(Cod.IBGE) %>% 
...
```{r}
educacao_muni <- readxl::read_excel("C:\\Users\\feref\\OneDrive\\Faculdade\\Lab de Econo\\docs_lab_econo\\Base Final Despesa Total com Educação - Base Única - SIOPE e Finbra - Procedimento Completo - Imputar Missings e Outliers.xlsx") %>% 
...
igp <- readxl::read_excel("C:\\Users\\feref\\OneDrive\\Faculdade\\Lab de Econo\\docs_lab_econo\\InvPub_lab_de_econo\\script_inv\\igp_di_gv.xlsx") %>%
  mutate(
    Data = my(Data),        
    ano = year(Data)        
  )
